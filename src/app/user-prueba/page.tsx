  ...
  return (
    <section>
      ...
      <main>
        <header>
          <h2>Mis libros</h2>
          <h2>Libros de Andrés Vizcaíno</h2>
        ...
        <section>
          <section>
            ...
            <p>Andrés Vizcaíno aún no tiene libros publicados.</p>
            <Link href="/books/add">
              <ArrowRight />
          ...
          <section>
            ...
            <form action="" aria-label="Filtrar libros">
              ...
              <fieldset>
                <label htmlFor="search-input-user">
                  <Search />
                  <input
                ...
                <fieldset>
                  ...
                  <label htmlFor="matematicas-1-user">
                    <input
                      id="matematicas-1-user"
                      type="checkbox"
                      name="matematicas"
                      value="matematicas"
                    />
                  ...
                  <label htmlFor="programacion-1-user">
                    <input
                      id="programacion-1-user"
                      type="checkbox"
                      name="programacion"
                      value="programacion"
                    />
                  ...
                  <label htmlFor="autoayuda-1-user">
                    <input
                      id="autoayuda-1-user"
                      type="checkbox"
                      name="autoayuda"
                  ...
                  <label htmlFor="literatura-1-user">
                    <input
                      id="literatura-1-user"
                      type="checkbox"
                      name="literatura"
                      value="literatura"
                    />
            ...
            <article>
              ...
              <div>
                ...
                <div>
                  ...
                  <ul
                    role="menu"
                    aria-labelledby="menu-actions-button-1-user"
                    id="menu-1"
                  >
                    <li role="menuitem">
            ...
            <article>
              ...
              <div>
                ...
                <div>
                  ...
                  <ul
                    role="menu"
                    aria-labelledby="menu-actions-button-2-user"
                    id="menu-2"
                  >
                    <li role="menuitem">
                      <Link href="#">Ver detalles</Link>
            ...
            <article>
              ...
              <div>
                ...
                <div>
                  ...
                  <ul
                    role="menu"
                    aria-labelledby="menu-actions-button-3-user"
                    id="menu-3"
                  >
                    <li role="menuitem">
                      <Link href="#">Ver detalles</Link>
            ...
            <article>
              ...
              <div>
                ...
                <div>
                  ...
                  <ul
                    role="menu"
                    aria-labelledby="menu-actions-button-4-user"
                    id="menu-4"
                  >
                    <li role="menuitem">
                      <Link href="#">Ver detalles</Link>
            ...
            <article>
              ...
              <div>
                ...
                <div>
                  ...
                  <ul
                    role="menu"
                    aria-labelledby="menu-actions-button-5-user"
                    id="menu-5-user"
                  >
                    <li role="menuitem">
                      <Link href="#">Ver detalles</Link>
